    ...
    <div className="min-h-screen bg-gray-50 dark:bg-black text-gray-700 dark:text-gray-300 font-mono">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 py-12">
        <div className="mb-12 text-center">
          ...
          <div className="mt-6 inline-flex items-center gap-3 border border-gray-300 dark:border-gray-700 px-5 py-2">
        ...
        <div className="mt-12 text-center text-gray-300 dark:text-gray-700 text-xs">
