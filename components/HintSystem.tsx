    ...
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="px-3 py-1 text-xs font-mono border border-green-500 text-green-400 hover:bg-green-500 hover:text-black transition-all duration-200 disabled:opacity-30 disabled:cursor-not-allowed"
        >
      ...
      <div className="space-y-2">
        {hints.slice(0, revealed).map((hint, i) => (
          ...
          >
            ...
            <span className="text-gray-300 font-mono text-xs">{hint}</span>
          </div>
        ))}
      </div>
    </div>
